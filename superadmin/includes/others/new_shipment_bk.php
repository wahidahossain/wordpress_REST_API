            ...
            <a href="add_new_parcel.php" name="Add New" class="btn btn-primary">Parcel</a> <a href="add_new_freight.php" name="Add New" class="btn btn-primary">Freight</a><br />
                          ...
                          <div class="card card-primary">
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="card card-body" style='display:none;' id='dRequestReturnLabel'>
                                            <div class="form-group">
                                                <label class="text-success">Request Return Label</label>                                    
                                                <select class="custom-select" name="requestReturnLabel" id='requestReturnLabel1' onchange='returnLabel()'>
                                                <option value="" selected>Select Option</option>
                                            ...
                                            <div class="card card-body" style='display:none;' id='yes_requestReturnLabel'>
                                                <div class="form-group">
                                                    <label class="text-success">Return Way bill number</label>
                                                    <input name="returnWaybill" id="returnWaybill" type="text" class="form-control"> eg. Q1234568
                                ...
                                <div class="form-group">
                                        ...
                                        <select class="custom-select" name="billing_account_id" required>
                                         ...
                                         include("../model/connect.php");                                                                    
                                            $results_customer = mysqli_query($con, "SELECT * FROM `billing_account` where `flag` = '1'");                                                
                                ...
                                <div class="card-header">
                                    <h3 class="card-title text-primary">Sender Information</h3>
                                </div>
                                <div class="form-group">
                                    <label>Sender</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" name="parcel_category" id='select_category' onchange='populateField()' required>
                                        <option value="">Select Option</option>
                                        <option value="Freight" >Freight</option>
                                        <option value="Parcel">Parcel Canada</option>                                        
                                    </select>
                                ...
                                <div style='display:none;' id='parcel_canada'>
                                    <!-- parcel_canada ==============CLICK EVENT======== -->
                                    <p class="text-success">Parcel Type (Parcel Canada): </p> 
                                    <select class="custom-select" name="parcelTypeParcelCanada">
                                        <option value="">Select Option</option>
                                        <option value="Box">Box</option>                                       
                                ...
                                <div class="card card-body" style='display:none;' id='airb'>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" name="preferences">
                                        <option value="open_text">Open Text</option> 
                                        <!-- <option value="predefined">predefined</option> -->
                                    </select>                                                  
                                    <label>References</label>   
                                    <select class="custom-select" name="references_type">
                                    ...
                                    <div style='display:none;' id='surcharges_type_parcel'>
                                    <select class="custom-select" name="surcharges_type_parcel" id='select_surcharges1' onchange='selectSurcharges1()'>
                                        <option value="">Select Option</option>

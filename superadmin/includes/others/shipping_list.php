                         ...
                         while ($row = mysqli_fetch_array($result))
                         {
                            ...
                            // End consignee table information ============================================
                             ...
                             ?>         
                               ...
                               <td><a href="../model/del_shippment.php?id=<?php echo $id;?>&new_shipment_id=<?php echo $new_shipment_id;?>&consignee_id=<?php echo $consignee_id;?>" onclick="return confirm('Want to delect this shipment? Warning: Cannot revert the action.')"><i class="nav-icon fa fa-trash"></i></span><?php //echo $subtrackingNumber; ?> <?php //echo $createDate;?></a></td>
                               <td>                                
                               <?php echo "<a href='shipping_details.php?new_shipment_id=".$new_shipment_id."' target='_blank'>Details</a>";?></td>                               
                               </tr>
                               <?php
                               }
                               ?>                                 
